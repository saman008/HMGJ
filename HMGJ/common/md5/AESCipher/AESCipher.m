...
NSString * aesEncryptString(NSString *content, NSString *key) {
    ...
    if (!encrptedData  || [encrptedData  length] == 0) {
        return @"";
    }
    NSMutableString *string = [[NSMutableString alloc] initWithCapacity:[encrptedData  length]];
    
    [encrptedData  enumerateByteRangesUsingBlock:^(const void *bytes, NSRange byteRange, BOOL *stop) {
