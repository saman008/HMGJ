...
class shopHomeTableViewCell: UITableViewCell {
    ...
    var model:homeliushuiDetailModel? = nil{
        ...
        didSet{
            ...
            if let bb = model?.paywayImg{
                self.headerImageView.sd_setImage(with: URL.init(string: bb), placeholderImage: nil)
